      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div className="topbar">
          <div>
            ...
            <h1>仪表盘</h1>
            <div className="sub">
              AI 驱动的测试用例生成平台 · {stats.product_count} 个产品 · {stats.iteration_count} 个活跃迭代
            </div>
          </div>
        ...
        <div className="grid-4" style={{ marginBottom: 24 }}>
          ...
          <div className="card" style={{ borderLeft: `3px solid ${stats.coverage_rate >= 80 ? "var(--accent)" : "var(--amber)"}` }}>
            <div className="stat-val" style={{ color: stats.coverage_rate >= 80 ? "var(--accent)" : "var(--amber)" }}>
