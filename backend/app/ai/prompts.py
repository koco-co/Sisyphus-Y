...
- FORMAT-006: 用例标题命名规范 — 格式: [优先级]-[模块]-[场景]-[操作]-[预期概要]
- FORMAT-007: 步骤描述规范 — 操作步骤使用祈使句（如"点击""输入"），预期结果使用陈述句（如"系统显示""字段值为"）
...
- QUALITY-009: 边界覆盖 — 每个功能模块至少包含边界值场景 1 条、异常场景 1 条、性能场景 1 条"""
